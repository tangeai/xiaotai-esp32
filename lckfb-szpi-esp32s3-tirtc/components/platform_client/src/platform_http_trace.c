...
/* Only these two pointers live in internal RAM (8 bytes on S3). No mutex,
 * task, TLS slot, allocation or log occurs in the transport wrappers.
 * Other tasks only read s_owner; the owner alone dereferences s_trace. */
