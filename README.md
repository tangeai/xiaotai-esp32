...
[下载固件](#下载固件) · [变更记录](CHANGELOG.md) · [在线烧录](https://espressif.github.io/esptool-js/) · [体验平台](https://xiaotai.chat/) · [服务端与小程序](https://github.com/tangeai/tirtc-server-example)
...
- **版本改动**：[CHANGELOG](CHANGELOG.md)，按版本集中查看 S3/P4 的功能、修正与依赖变化。
